...
import { Box, Grid, Typography, useTheme, Tooltip, Chip } from '@mui/material'
...
const ItemCard = ({ data: initialData, images, icons, nodeTypes, onClick, type, updateFlowsApi, setError, href }) => {
                        ...
                        {(images?.length > 0 || icons?.length > 0) && (
                            ...
                            >
                                ...
                                {icons && (
                                    ...
                                    >
                                        {icons.slice(0, icons.length > 3 ? 3 : icons.length).map((ic, index) => (
                                            <div
                                                key={index}
                                                style={{
                                                    width: 30,
                                            ...
                                            >
                                                <ic.icon size={25} color={ic.color} />
                                            </div>
                                        ))}
                                        {icons.length > 3 && (
                                            <Typography sx={{ alignItems: 'center', display: 'flex', fontSize: '.9rem', fontWeight: 200 }}>
