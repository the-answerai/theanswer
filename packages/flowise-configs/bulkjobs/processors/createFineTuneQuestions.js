...
const createFineTuneQuestions = {
    ...
    fieldsProcessor: (response, entry, locale) => {
        ...
        for (let i = 0; i < json.length; i++) {
            ...
            if (categories.some((category) => category.fields.internalTitle.includes('Advertiser + Agency Solutions'))) {
                persona = 'advertiser-agency'
            } else if (categories.some((category) => category.fields.internalTitle.includes('Publisher'))) {
                persona = 'publisher'
            }
