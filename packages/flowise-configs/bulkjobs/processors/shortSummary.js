const instructions = `
    ...
    Include the type of coorespondence and with whom, the main points, and resolution or next steps. Also information for Bradleys lawyer about the details of the content.
    The summary should be written using as few words as possible.
    It should be writtenas a short paragraph and easily scanable by a lawyer looking at a list of summaries.
    `
const shortSummary = {
    name: 'shortSummary',
