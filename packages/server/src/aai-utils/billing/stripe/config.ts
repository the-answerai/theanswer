...
export const STRIPE_CONFIG = {
    CREDIT_TO_USD: BILLING_CREDIT_PRICE_USD, // Cost per credit in USD
    ...
    METERS: {
        ...
        COMPUTE: {
            ...
            BASE_PRICE_USD: BILLING_CREDIT_PRICE_USD * 50, // 50x base price for compute
            MARGIN_MULTIPLIER: 1.2,
            METER_NAME: 'Compute Usage'
        },
        STORAGE: {
            GB_PER_CREDIT: BILLING_CONFIG.STORAGE.GB_PER_CREDIT,
            BASE_PRICE_USD: BILLING_CREDIT_PRICE_USD * 500, // 500x base price for storage
            MARGIN_MULTIPLIER: 1.2,
