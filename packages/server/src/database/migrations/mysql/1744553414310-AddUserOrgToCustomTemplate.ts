...
export class AddUserOrgToCustomTemplate1744553414310 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`custom_template\` ADD \`userId\` varchar(255)`)
        await queryRunner.query(`ALTER TABLE \`custom_template\` ADD \`organizationId\` varchar(255)`)
    }
