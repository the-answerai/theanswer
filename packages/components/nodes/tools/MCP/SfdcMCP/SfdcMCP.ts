...
class Sfdc_MCP implements INode {
    ...
    async getTools(nodeData: INodeData, options: ICommonObject): Promise<Tool[]> {
        ...
        const salesforceClientId = getCredentialParam('salesforceClientId', credentialData, nodeData)
        const salesforceClientSecret = getCredentialParam('salesforceClientSecret', credentialData, nodeData)
        const salesforceInstance = getCredentialParam('salesforceInstance', credentialData, nodeData)
        const packagePath = getNodeModulesPackagePath('@tsmztech/mcp-server-salesforce/dist/index.js')
