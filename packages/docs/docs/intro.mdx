...
Have questions about AnswerAgent? Want to learn how to use specific features or explore what the platform can do? **Meet Alpha**, your AI assistant who knows everything about AnswerAgent!
...
>
    <p style={{ marginBottom: '1rem' }}>Click below to start a conversation with Alpha:</p>
    <AskAlphaButton
        variant='button'
        size='large'
        context={{
            page: 'documentation',
            section: 'intro',
            content: 'Getting started with AnswerAgent documentation'
        }}
    />
</div>

**Alpha can help you with:**

-   Understanding AnswerAgent features and capabilities
-   Getting started with your first agent or workflow
-   Troubleshooting and best practices
-   Integration guidance and API documentation
-   Scheduling a demo or connecting with our support team

Don't hesitate to ask Alpha anything - from basic questions to complex implementation scenarios!
