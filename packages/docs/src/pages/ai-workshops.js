...
function WorkshopsHero() {
    return (<header className={(0, clsx_1.default)('hero hero--primary', index_module_css_1.default.heroSection)}>
            ...
            <div className={index_module_css_1.default.heroContent}>
                <h1 className={index_module_css_1.default.heroTitle}>AI Workshops for Your Team</h1>
                ...
                <div className={index_module_css_1.default.heroCTAs}>
                    <a href='https://calendly.com/lastrev-brad/ai-workshop-discovery-call' className={(0, clsx_1.default)(index_module_css_1.default.ctaButton, index_module_css_1.default.ctaPrimary)}>
                        Book Consultation
                    </a>
                    <div className={index_module_css_1.default.secondaryLinks}>
                        <a href='#how-it-works' className={index_module_css_1.default.secondaryLink}>
                            🎯 How It Works
                        </a>
                        <ElevenLabsInlineWidget_1.default agentId='agent_01k03gnw7xe11btz2vprkf7ay5' text='🤖 Talk to an Agent Now' variant='chip' inline={true} showStatus={false}/>
                    </div>
                </div>
            </div>
        </header>);
...
function ProminentCTASection() {
    return (<section className={index_module_css_1.default.missionSection}>
            <div className='container'>
                <div className='row'>
                    <div className='col col--12'>
                        <div className={index_module_css_1.default.prominentCTAHeader}>
                            <div className={index_module_css_1.default.comingSoonIcon}>🎉</div>
                    ...
                    <div className='col col--6'>
                        <div className={(0, clsx_1.default)(index_module_css_1.default.featureCard, index_module_css_1.default.commandment)}>
                            ...
                            <div>
                                ...
                                <ElevenLabsInlineWidget_1.default agentId='agent_01k03gnw7xe11btz2vprkf7ay5' text='🤖 Talk to an Agent' variant='cta' buttonClassName={"".concat(index_module_css_1.default.ctaButton, " ").concat(index_module_css_1.default.ctaPrimary)} inline={true} showStatus={false}/>
                            </div>
                        </div>
                    </div>
                    <div className='col col--6'>
                        <div className={(0, clsx_1.default)(index_module_css_1.default.featureCard, index_module_css_1.default.commandment)}>
                            ...
                            <div>
                                ...
                                <a href='https://calendly.com/lastrev-brad/ai-workshop-discovery-call' className={(0, clsx_1.default)(index_module_css_1.default.ctaButton, index_module_css_1.default.ctaPrimary)} target='_blank' rel='noopener noreferrer'>
...
function HowItWorksSection() {
    return (<section className={index_module_css_1.default.featuresSection} id='how-it-works'>
            <div className='container'>
...
function LocationsSection() {
    return (<section className={index_module_css_1.default.featuresSection} id='locations'>
            <div className='container'>
...
function PricingCTASection() {
    return (<section className={index_module_css_1.default.pricingSection} id='pricing'>
            <div className='container'>
                    ...
                    <div className='col col--8 col--offset-2'>
                        <div className={(0, clsx_1.default)(index_module_css_1.default.pricingCard, index_module_css_1.default.commandment, index_module_css_1.default.pricingCardHighlighted)}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                                ...
                                <div className={index_module_css_1.default.pricingHighlight}>Fixed Cost + Per Person</div>
                                ...
                                <div className='text--center' style={{ marginTop: 'auto' }}>
                                    <div className={(0, clsx_1.default)(index_module_css_1.default.commandment, index_module_css_1.default.comingSoonCard)} style={{
            marginBottom: '2rem',
            ...
            border: '2px solid #ff4444'
                                    ...
                                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                                        <ElevenLabsInlineWidget_1.default agentId='agent_01k03gnw7xe11btz2vprkf7ay5' text='🤖 Talk to an Agent' inline={true} showStatus={false}/>
                                        <a href='https://calendly.com/lastrev-brad/ai-workshop-discovery-call' className={(0, clsx_1.default)(index_module_css_1.default.ctaButton, index_module_css_1.default.ctaSecondary)}>
...
function AIWorkshops() {
    return (<div data-theme='dark'>
            <Layout_1.default title='AI Workshops - Transform Your Team' description='Expert-led AI workshops for your team. 3 days online + 2 days in-person training. Complete experience with Answer Academy access, hands-on learning, and team events.'>
                <WorkshopsHero />
