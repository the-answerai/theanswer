...
function CreatorsHero() {
    return (<header className={(0, clsx_1.default)('hero hero--primary', index_module_css_1.default.heroSection)}>
            ...
            <div className={index_module_css_1.default.heroContent}>
                <h1 className={index_module_css_1.default.heroTitle}>Your Art Matters. Your Voice Matters. Your Choice Matters.</h1>
                ...
                <div className={index_module_css_1.default.heroCTAs}>
                    <a href='#join-waitlist' className={(0, clsx_1.default)(index_module_css_1.default.ctaButton, index_module_css_1.default.ctaPrimary)}>
                        Join the Creator Alliance
                    </a>
                    <div className={index_module_css_1.default.secondaryLinks}>
                        <a href='#the-problem' className={index_module_css_1.default.secondaryLink}>
                            🎨 The Problem
                        </a>
                        <a href='#our-solution' className={index_module_css_1.default.secondaryLink}>
                            ✨ Our Solution
                        </a>
                    </div>
                </div>
...
function OpeningHook() {
    return (<section className={(0, clsx_1.default)(index_module_css_1.default.missionSection, index_module_css_1.default.comingSoonSection)} id='the-problem'>
    ...
    return (<section className={index_module_css_1.default.featuresSection}>
            <div className='container'>
                ...
                <div className='text--center' style={{ marginTop: '3rem' }}>
                    <a href='/blog/original-sin' className={(0, clsx_1.default)(index_module_css_1.default.ctaButton, index_module_css_1.default.secondaryLink)} style={{ padding: '1rem 2rem', fontSize: '1.1rem' }}>
...
function OurSolution() {
    return (<section className={index_module_css_1.default.featuresSection} id='our-solution'>
            <div className='container'>
...
function JoinWaitlist() {
    return (<section className={index_module_css_1.default.featuresSection} id='join-waitlist'>
            <div className='container'>
                ...
                <div className='row'>
                    <div className='col col--6'>
                        <div className={index_module_css_1.default.featureCard}>
                            ...
                            <a href='https://share.hsforms.com/your-hubspot-form-id' className={index_module_css_1.default.featureCardCTA} target='_blank' rel='noopener noreferrer'>
                                Submit Your Work →
                            </a>
                        </div>
                    </div>
...
function ClosingRally() {
    return (<section className={(0, clsx_1.default)(index_module_css_1.default.missionSection, index_module_css_1.default.ctaSection)}>
            <div className='container text--center'>
                ...
                <div className={index_module_css_1.default.heroCTAs}>
                    <a href='https://share.hsforms.com/your-hubspot-form-id' className={(0, clsx_1.default)(index_module_css_1.default.ctaButton, index_module_css_1.default.ctaPrimary)} target='_blank' rel='noopener noreferrer'>
                        Join the Creator Alliance Today
                    </a>
                    <div className={index_module_css_1.default.secondaryLinks}>
                        <a href='/blog/original-sin' className={index_module_css_1.default.secondaryLink}>
                            📖 Read "Original Sin"
                        </a>
...
function Creators() {
    ...
    return (<div data-theme='dark'>
            <Layout_1.default title='Creators - Help Us Build Ethical AI That Respects Your Work' description="Join the Creator Alliance. Help build the world's first 100% ethically curated AI models that pay creators fairly and respect consent. Your art matters. Your voice matters. Your choice matters.">
                <CreatorsHero />
                <main>
                    <OpeningHook />
                    <OriginalSinSection />
